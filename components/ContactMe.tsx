...
function ContactMe({}: Props) {
  ...
  const onSubmit: SubmitHandler<Inputs> = (formData) => {
    const mailto = `mailto:dipshansharma390@gmail.com?subject=${encodeURIComponent(
      formData.subject
  ...
  return (
    <div className='h-[150vh] flex relative flex-col text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
      ...
      <div className='flex flex-col space-y-10'>
        ...
        <div className='space-y-10'>
          <div className='flex items-center space-x-5 justify-center'>
            ...
            <p className='text-2xl'>+977 9766869658</p>
          </div>

          <div className='flex items-center space-x-5 justify-center'>
            <MapPinIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse' />
            <p className='text-2xl'>Bhrikuti Tol, Kathmandu</p>
          </div>

          <div className='flex items-center space-x-5 justify-center'>
            <EnvelopeIcon className='text-[#F7AB0A] h-7 w-7 animate-pulse' />
            <p className='text-2xl'>dipshansharma390@gmail.com</p>
          </div>
        </div>
